      ...
      <main className="flex-1 lg:ml-64 pt-16 lg:pt-12 px-4 pb-4 sm:px-6 sm:pb-6 lg:px-12 lg:pb-12 max-w-5xl mx-auto w-full relative">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeSection === 'enterprise' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">商业模式拓展思考：从现有业务到新增长曲线</h2>
          ...
          {activeSection === 'interaction' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">关键交互设计思考：让用户100%信任AI的输出</h2>
                <p className="text-zinc-400 text-lg max-w-3xl leading-relaxed">
          ...
          {activeSection === 'mapping' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">先看全局：全球金融AI竞争格局</h2>
                <p className="text-zinc-400 text-lg max-w-3xl leading-relaxed">
          ...
          {activeSection === 'algorithm' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">算法架构思考：从底层引擎到技能编排</h2>
                <div className="text-zinc-400 text-base max-w-3xl leading-relaxed space-y-3">
                  <p>算法上有两个思考：</p>
          ...
          {activeSection === 'workflow' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">深度Workflow沉淀：把分析师的经验变成可复用的流程</h2>
                <p className="text-zinc-400 text-lg max-w-3xl leading-relaxed">
          ...
          {activeSection === 'plugin' && (
            ...
            >
              <header>
                <h2 className="text-3xl font-semibold text-zinc-100 tracking-tight mb-4">插件生态思考：要不要自己做插件？</h2>
          ...
          {activeSection === 'summary' && (
            ...
            >
              <div className="text-center">
                <h2 className="text-3xl font-bold text-zinc-100 tracking-tight">Summary</h2>
              </div>
